...
import com.frankokafor.card_verification.exception.CardInfoServiceException;
import com.frankokafor.card_verification.exception.ErrorMessages;
import com.frankokafor.card_verification.model.CardInfo;
import com.frankokafor.card_verification.model.Payload;
import com.frankokafor.card_verification.pojo.ExtractPojo;
...
public class CardDetailsInfoServiceImpl implements CardDetailsInfoService {
	...
	private InfoResponse cardInfo(String number) {
		...
		if (info == null) {
			ExtractPojo pojo = restTemplate.getForObject("https://lookup.binlist.net/" + num, ExtractPojo.class);
			if (pojo == null) {
